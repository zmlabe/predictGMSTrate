...
plt.plot(years,freq_obs,linewidth=4,color='crimson',alpha=2,zorder=3,clip_on=False,
          linestyle='--',dashes=(1,0.3))
for i in range(len(rects)):
    rects[i].set_color('w')
    rects[i].set_edgecolor('k')
...
plt.text(1990,0.9,r'\textbf{ACTUAL SLOWDOWN}',fontsize=16,color='w',alpha=0.9)
plt.text(1990,0.8,r'\textbf{{PREDICTED SLOWDOWN}',fontsize=16,color='crimson',alpha=1) 
plt.ylabel(r'\textbf{Frequency of Classification}',color='w',fontsize=10)    
...
plt.bar(years,IPO,color='deepskyblue',
        edgecolor='deepskyblue',zorder=9,linewidth=0.3) 
plt.bar(years,IPO_masked,
        color='crimson',edgecolor='crimson',zorder=9,clip_on=False,
        linewidth=0.3) 
...
plt.ylabel(r'\textbf{Unfiltered IPO Index}',color='w',fontsize=10)    
        
plt.tight_layout()
plt.subplots_adjust(hspace=0.4)

plt.savefig(directoryfigure + 'Figure_4_DARK.png',dpi=600)