...
plt.title(r'\textbf{ACTUAL SLOWDOWN}',fontsize=17,color='dimgrey')       
...
plt.title(r'\textbf{FUTURE SLOWDOWN}',fontsize=17,color='dimgrey')       
...
plt.savefig(directoryfigure + 'LRP_Observations.png',dpi=600)