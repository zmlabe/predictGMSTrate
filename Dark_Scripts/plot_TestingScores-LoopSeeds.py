"""
Create plots to show testing  scores for different seeds
...
plt.plot([], c=cp, label=r'\textbf{TESTING}',clip_on=False)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'TestingScores-LoopSeeds_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=300)
else:
    plt.savefig(directoryfigure + 'TestingScores-LoopSeeds_Hiatus_EDA-v2.png',dpi=300)