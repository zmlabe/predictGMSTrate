...
plt.tight_layout()
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'RawCompositesHiatusCLIMATECHANGE_v1_AccH-%s_AccR-%s_rmENSEMBLEmean.png' % (accurate,accurate),dpi=300)
else:
    plt.savefig(directoryfigure + 'RawCompositesHiatusCLIMATECHANGE_v1_AccH-%s_AccR-%s.png' % (accurate,accurate),dpi=300)