...
## Conferences
+ **[2]** **Labe, Z.M.** and E.A. Barnes. Temporary slowdowns in decadal warming predictions by a neural network, *CLIVAR Climate Dynamics Panel (CDP) annual workshop: External versus internal variability on decadal and longer time scales*, Virtual Workshop (Oct 2022) [[POSTER]](https://zacklabe.files.wordpress.com/2022/09/labebarnes_poster_10-2022.pdf)
