...
showing all the difference OHC levels and for a lead period before
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'RawCompositesHiatus_OHClevels-lead3to0_v2_AccH-%s_AccR-%s_rmENSEMBLEmean_test_thoughtfulcomposite.png' % (accurate,accurate),dpi=300)
else:
    plt.savefig(directoryfigure + 'RawCompositesHiatus_OHClevels-lead3to0_v2_AccH-%s_AccR-%s_test_thoughtfulcomposite.png' % (accurate,accurate),dpi=300)