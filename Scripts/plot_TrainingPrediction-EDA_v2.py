"""
Second exploratory data analysis for making plots of training accuracy
...
directoryfigure = '/Users/zlabe/Desktop/GmstTrendPrediction/ANN_v2/Training/'
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'Training_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=300)
else:
    plt.savefig(directoryfigure + 'Training_Hiatus_EDA-v2.png',dpi=300)
