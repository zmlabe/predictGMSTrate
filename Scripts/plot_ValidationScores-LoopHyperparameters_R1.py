...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'AccracyScores-LoopHyperparameters_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'AccuracyScores-LoopHyperparameters_Hiatus_EDA-v2.png',dpi=1000)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'PrecisionScores-LoopHyperparameters_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'PrecisionScores-LoopHyperparameters_Hiatus_EDA-v2.png',dpi=1000)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'RecallScores-LoopHyperparameters_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'RecallScores-LoopHyperparameters_Hiatus_EDA-v2.png',dpi=1000)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'F1Scores-LoopHyperparameters_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'F1Scores-LoopHyperparameters_Hiatus_EDA-v2.png',dpi=1000)
...
for plo in range(len(hiddenall)):
    ...
    for i in range(len(ridgePenaltyall)):
        ...
        plt.plot(x, y,color='darkblue', alpha=0.8,zorder=10,marker='.',linewidth=0,markersize=5,markeredgewidth=0)
    for i in range(len(ridgePenaltyall)):
        y = plotdata2[:,i]
        x = np.random.normal(positionspost[i], 0.04, size=len(y))
        plt.plot(x, y,color='darkred', alpha=0.8,zorder=10,marker='.',linewidth=0,markersize=5,markeredgewidth=0)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'CombinedScores-LoopHyperparameters_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'CombinedScores-LoopHyperparameters_Hiatus_EDA-v2.png',dpi=1000)