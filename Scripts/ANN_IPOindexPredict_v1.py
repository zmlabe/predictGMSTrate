"""
Create an ANN to predict hiatus from only the IPO index
...
IPOtrain = IPO.transpose()[trainindices,:yearsall.shape[0]]
IPOtest = IPO.transpose()[testindices,:yearsall.shape[0]]
IPOval= IPO.transpose()[valindices,:yearsall.shape[0]]
...
XtrainS = IPOtrain.reshape(trainindices.shape[0]*yearsall.shape[0],1)
XvalS = IPOval.reshape(valindices.shape[0]*yearsall.shape[0],1)
XtestS = IPOtest.reshape(testindices.shape[0]*yearsall.shape[0],1)
