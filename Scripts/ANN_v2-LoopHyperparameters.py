...
#         for seee in range(1):
            ...
            dirname = '/Users/zlabe/Documents/Research/GmstTrendPrediction/Data/LoopHyperparameters/SavedModels/'
            ...
            directoryoutput = '/Users/zlabe/Documents/Research/GmstTrendPrediction/Data/LoopHyperparameters/'
            ...
            np.savez(directoryoutput + savename + '_SCORES_LoopHyper.npz',
...
### Save seeds
np.savez(directoryoutput + 'Metadata_LoopResultsfor_ANNv2_OHC100_hiatus_EnsembleMeanRemoved_LoopHyper.npz',
