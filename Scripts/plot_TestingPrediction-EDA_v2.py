"""
Second exploratory data analysis for making plots of testing accuracy
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'TestingConfidence_Hiatus_EDA-v2_rmENSEMBLEmean.png',dpi=300)
else:
    plt.savefig(directoryfigure + 'TestingConfidence_Hiatus_EDA-v2.png',dpi=300)
