...
directoryfigure = '/Users/zlabe/Desktop/GmstTrendPrediction/ANN_v2/LRP/SST/'
...
label = r'\textbf{LRP Relevance - ANN using SST}'
...
plt.tight_layout()
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'SST_LRP-EDA_Testing_v2_AccH-%s_AccR-%s_rmENSEMBLEmean.png' % (accurateH,accurateR),dpi=300)
else:
    plt.savefig(directoryfigure + 'SST_LRP-EDA_Testing_v2_AccH-%s_AccR-%s.png' % (accurateH,accurateR),dpi=300)
...
if rm_ensemble_mean == True:
    plt.savefig(directoryfigure + 'SST_LRP-EDA_Observations_v2_AccH-%s_AccR-%s_rmENSEMBLEmean.png' % (accurateH,accurateR),dpi=300)
else:
    plt.savefig(directoryfigure + 'SST_LRP-EDA_Observations_v2_AccH-%s_AccR-%s.png' % (accurateH,accurateR),dpi=300)
...
def netcdfLRP(lats,lons,var,directory,typemodel,saveData):
    ...
    name = 'LRP_comp/SST_LRPMap_comp_' + typemodel + '_' + saveData + '.nc'
