"""
Script plots moving trend slopes over time (example plot of metric)
...
plt.plot(timetrend_m[exampleens,:],color='maroon',linewidth=1.5,alpha=1,clip_on=False)
plt.plot(timetrend_o,color='k',linewidth=4,alpha=1,clip_on=False,
         linestyle='-',label=r'\textbf{ERA5}')

plt.axhline(SLOPEthreshh_o,color='k',linewidth=1,linestyle='--',dashes=(1,0.3))
...
plt.plot(classes_mhplot[exampleens,:],color='maroon',marker='o',clip_on=False,
         markersize=10)
...
plt.text(101,SLOPEthreshh_o,r'\textbf{ERA5 Threshold}',color='k',fontsize=6,
         va='center')
plt.text(101,(SLOPEthreshh_m*diff_o)[-1],r'\textbf{CESM2-LE Threshold}',color='teal',fontsize=6,
         va='center')
plt.text(101,timetrend_m[exampleens,-1],r'\textbf{Ensemble \#%s}' % (exampleens+1),color='maroon',fontsize=6,
         va='center')
