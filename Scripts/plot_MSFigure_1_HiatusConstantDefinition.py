...
import numpy as np
import calc_HiatusConstantDefinition_v1 as HA
...
directoryfigure = '/Users/zlabe/Desktop/GmstTrendPrediction/HiatusConstantDefinition/'
...
plt.text(2091,modelsm.squeeze()[exampleens,-10]-0.1,r'\textbf{Ensemble \#%s}' % (actualnumberENS),
...
plt.tight_layout()    
plt.savefig(directoryfigure + 'Figure_1_HiatusConstantDefinition.png',dpi=300)