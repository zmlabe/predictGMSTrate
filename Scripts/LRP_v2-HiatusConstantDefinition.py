...
def netcdfLRP(lats,lons,var,directory,typemodel,saveData):
    ...
    name = 'ConstantDefinition_LRPMap' + typemodel + '_' + saveData + '.nc'
...
directoryoutput = '/Users/zlabe/Documents/Research/GmstTrendPrediction/Data/HiatusConstantDefinition/'
