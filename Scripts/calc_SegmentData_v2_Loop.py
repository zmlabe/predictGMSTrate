...
-----
    ...
    Version : 2  (added validation data slice AND looping through sizes)
    
Usage
-----
    [1] segment_data(data,classesl,fac,random_segment_seed)
"""
def segment_data(data,classesl,fac,random_segment_seed,trainN,testN,valN):
    """
